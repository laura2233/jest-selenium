...
describe("Login Function", () => {
  ...
  test('should display error message with blank user ID', async() => {
    ...
    await driver.findElement(By.id("divErrors")).getText().
      then(value => {expect(value).toEqual(expect.stringContaining("You must specify a non-blank User ID"))})
  })
  ...
  test('should display error message with blank password', async() => {
    ...
    await driver.findElement(By.id("divErrors")).getText().then(value => {
      expect(value).toEqual(expect.stringContaining("You must specify a non-blank Password"))})
  }) 
  ...
  test('should login with valid username and password', async() => {
    ...
    await driver.getCurrentUrl().then(value => {
      expect(value).toEqual(expect.stringContaining("/prod/Sidebar"))}) 
  }) 
